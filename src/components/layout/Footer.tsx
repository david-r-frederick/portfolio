...
export const Footer = () => {
  return (
    <footer className="relative border-t bg-background py-16 overflow-hidden">
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 h-64 w-[800px] bg-primary/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="container relative z-10 mx-auto px-4 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-10 md:flex-row">
          <div className="text-center md:text-left">
            ...
            <p className="text-sm font-semibold text-muted-foreground uppercase tracking-widest">Full-Stack Software Developer</p>
          </div>
          
          <div className="flex gap-4">
            {[
              { icon: <Github className="h-5 w-5" />, href: "https://github.com/david-r-frederick" },
              { icon: <Linkedin className="h-5 w-5" />, href: "https://linkedin.com/in/david-frederick-413b30ab" },
